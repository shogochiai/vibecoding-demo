...
(define TimelineTest-assert (lambda (arg-0 arg-1) (cond ((equal? arg-0 1) (string-append arg-1 ": PASS")) (else (string-append arg-1 ": FAIL")))))
(define TimelineStorage-eventIndex (lambda (arg-0) (cond ((equal? arg-0 0) 0) ((equal? arg-0 1) 1) ((equal? arg-0 2) 2) (else 3))))
(define TimelineStorage-eventSlot (lambda (arg-0 arg-1) (+ (+ (* arg-0 4) 62514009886607029107290561805838585334079798074568712924583230797734656856475) (TimelineStorage-eventIndex arg-1))))
...
(define TimelineTest-test_slotsDistinct (let ((u--s0 (TimelineStorage-eventSlot 1 0))) (let ((u--s1 (TimelineStorage-eventSlot 1 1))) (let ((u--s2 (TimelineStorage-eventSlot 1 2))) (let ((u--s3 (TimelineStorage-eventSlot 1 3))) (TimelineTest-assert (let ((sc0 (PreludeC-45EqOrd-u--C-47C-61_Eq_Integer u--s0 u--s1))) (cond ((equal? sc0 1) (let ((sc1 (PreludeC-45EqOrd-u--C-47C-61_Eq_Integer u--s1 u--s2))) (cond ((equal? sc1 1) (let ((sc2 (PreludeC-45EqOrd-u--C-47C-61_Eq_Integer u--s2 u--s3))) (cond ((equal? sc2 1) (PreludeC-45EqOrd-u--C-47C-61_Eq_Integer u--s0 u--s3)) (else 0)))) (else 0)))) (else 0))) "test_REQ_TIMELINE_002_slotsDistinct"))))))
(define TimelineTest-test_slotStride (let ((u--s0 (TimelineStorage-eventSlot 0 0))) (let ((u--s1 (TimelineStorage-eventSlot 0 1))) (let ((u--s2 (TimelineStorage-eventSlot 0 2))) (let ((u--s3 (TimelineStorage-eventSlot 0 3))) (TimelineTest-assert (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer u--s1 (+ u--s0 1)))) (cond ((equal? sc0 1) (let ((sc1 (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer u--s2 (+ u--s0 2)))) (cond ((equal? sc1 1) (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer u--s3 (+ u--s0 3))) (else 0)))) (else 0))) "test_REQ_TIMELINE_002_slotStride"))))))
(define TimelineTest-test_proposalIsolation (let ((u--s0 (TimelineStorage-eventSlot 1 0))) (let ((u--s1 (TimelineStorage-eventSlot 2 0))) (TimelineTest-assert (PreludeC-45EqOrd-u--C-47C-61_Eq_Integer u--s0 u--s1) "test_REQ_TIMELINE_002_proposalIsolation"))))
(define PreludeC-45EqOrd-u--C-60_Ord_Integer (lambda (arg-0 arg-1) (let ((sc0 (or (and (< arg-0 arg-1) 1) 0))) (cond ((equal? sc0 0) 0)(else 1)))))
(define TimelineTest-test_eventOrdering (TimelineTest-assert (let ((sc0 (PreludeC-45EqOrd-u--C-60_Ord_Integer (TimelineStorage-eventIndex 0) (TimelineStorage-eventIndex 1)))) (cond ((equal? sc0 1) (let ((sc1 (PreludeC-45EqOrd-u--C-60_Ord_Integer (TimelineStorage-eventIndex 1) (TimelineStorage-eventIndex 2)))) (cond ((equal? sc1 1) (PreludeC-45EqOrd-u--C-60_Ord_Integer (TimelineStorage-eventIndex 2) (TimelineStorage-eventIndex 3))) (else 0)))) (else 0))) "test_REQ_TIMELINE_001_eventOrdering"))
(define TimelineTest-test_eventIndex (TimelineTest-assert (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer (TimelineStorage-eventIndex 0) 0))) (cond ((equal? sc0 1) (let ((sc1 (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer (TimelineStorage-eventIndex 1) 1))) (cond ((equal? sc1 1) (let ((sc2 (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer (TimelineStorage-eventIndex 2) 2))) (cond ((equal? sc2 1) (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer (TimelineStorage-eventIndex 3) 3)) (else 0)))) (else 0)))) (else 0))) "test_REQ_TIMELINE_001_eventIndex"))
(define TimelineTest-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr (string-append TimelineTest-test_eventIndex "\xa;") ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr (string-append TimelineTest-test_slotsDistinct "\xa;") ext-0))) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append TimelineTest-test_proposalIsolation "\xa;") ext-0))) (let ((act-4 (PreludeC-45IO-prim__putStr (string-append TimelineTest-test_slotStride "\xa;") ext-0))) (let ((act-5 (PreludeC-45IO-prim__putStr (string-append TimelineTest-test_eventOrdering "\xa;") ext-0))) (PreludeC-45IO-prim__putStr "PASS\xa;" ext-0))))))))
           ...
           (collect
            ...
            (let loop ([c this-counter] [gen 0])
              (cond
                ...
                [else
                 gen]))))]))))
(PrimIO-unsafePerformIO (lambda (eta-0) (TimelineTest-main eta-0)))
