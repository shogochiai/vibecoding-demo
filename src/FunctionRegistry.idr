...
||| REQ_DELEG_005: Delegation facet selector registration
||| Registers getProposalTimeline and delegation selectors in the UCS function registry
...
----------------------------------------------------------------------
-- REQ_DELEG_005: Delegation selector constants
----------------------------------------------------------------------

||| delegate(address) selector
public export
selectorDelegate : Integer
selectorDelegate = 0x5c19a95c

||| revokeDelegation() selector
public export
selectorRevokeDelegation : Integer
selectorRevokeDelegation = 0xa7713a70

||| getDelegate(address) selector
public export
selectorGetDelegate : Integer
selectorGetDelegate = 0xb5b3ca2c

||| getVotingPower(address) selector
public export
selectorGetVotingPower : Integer
selectorGetVotingPower = 0x7ed4b27c

----------------------------------------------------------------------
-- REQ_DELEG_005: Delegation registration entries
----------------------------------------------------------------------

||| Register all delegation facet selectors in the ERC-7546 registry.
||| @implAddr Address of the deployed Delegation facet contract
export
registerDelegation : Integer -> IO ()
registerDelegation implAddr = do
  sstore (registrySlot selectorDelegate) implAddr
  sstore (registrySlot selectorRevokeDelegation) implAddr
  sstore (registrySlot selectorGetDelegate) implAddr
  sstore (registrySlot selectorGetVotingPower) implAddr
...
|||   0x5c19a95c -> Delegation facet address
|||   0xa7713a70 -> Delegation facet address
|||   0xb5b3ca2c -> Delegation facet address
|||   0x7ed4b27c -> Delegation facet address
|||
||| dc9cc645 getImplementation(bytes4) routes delegation selectors
export
